...
service api {
    ...
    entity VistaUsuArg as select from Usuarios { *
    } where amigos > 200 and paisDeOrigen = 'ARG'; //no usar perfil, usar usuario 

    entity VistaPublicaciones as select from Publicaciones {
        titulo                  as Publicaciones_Titulo,
        cantDeVecesCompartido   as Publicaciones_CantComp,
        usuario.username        as Usuario_Username
    } where cantDeVecesCompartido > 100;
