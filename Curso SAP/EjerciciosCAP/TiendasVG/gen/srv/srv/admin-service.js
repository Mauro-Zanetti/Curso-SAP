...
module.exports = cds.service.impl(async (srv) => {
    ...
    srv.on('ManejoStock', async (req)=>{
        try {
            ...
            if (stock.length === 0) {
            ...
            } else if (stock[0].cantidad + cambio < stock[0].maxi && stock[0].cantidad + cambio > stock[0].mini) {
                ...
                + " | max|min: " + stock[0].maxi + "|" + stock[0].mini + " | cambio intencionado :" + cambio + "]";
            }
        } catch(err) {
            console.log("TERROR: ", err);
        }
    ...
    srv.on('DELETE','Duenios', async (req)=>{
